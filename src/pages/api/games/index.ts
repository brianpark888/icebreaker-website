...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (!team_id || !game_name || !game_type || !creator_username || !creator_id) {
  ...
  try {
    ...
    if (participantError) {
      console.error("Game created but failed to add creator as participant:", participantError.message)
